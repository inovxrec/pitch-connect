...
const steps = [
  {
    ...
    desc: "Submit your startup details and pitch deck through our simple application form.",
  },
  {
    icon: CheckCircle,
    title: "Get Shortlisted by KaroStartup",
    desc: "Our team reviews applications and shortlists the most promising startups.",
  },
  {
    icon: Mic,
    title: "Pitch Live to Investors",
    desc: "Present your startup directly to a panel of investors and mentors.",
  },
  {
    icon: Rocket,
    title: "Raise Funding and Scale",
    desc: "Get funded, receive mentorship, and take your startup to the next level.",
  },
];
          ...
          {steps.map((step, i) => (
            <div key={step.title} className="relative text-center group">
              <div className="relative z-10 w-24 h-24 rounded-2xl bg-card shadow-card mx-auto mb-6 flex items-center justify-center group-hover:shadow-card-hover transition-all duration-300 group-hover:-translate-y-1">
                ...
                <span className="absolute -top-2 -right-2 w-7 h-7 rounded-full gradient-primary flex items-center justify-center text-xs font-bold text-primary-foreground">
                  {i + 1}
                </span>
              </div>
