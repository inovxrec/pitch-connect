...
const startups = [
  {
    name: "FarmFresh",
    category: "AgriTech",
    desc: "Connecting farmers directly to urban consumers through a tech-enabled supply chain.",
    icon: Leaf,
  ...
  },
  {
    ...
    desc: "Manufacturing biodegradable packaging solutions for India's e-commerce boom.",
    icon: Package,
  ...
  },
  {
    name: "SkillSpark",
    category: "EdTech",
    desc: "Upskilling youth from Tier-2 cities with industry-relevant vocational training.",
    icon: BookOpen,
